...
const SignupPage = () => {
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    ...
    const newFormData = { ...restFormValue, role: "DOCTOR" };
  ...
  const fetchAllSpecialist = async (organizationId: number) => {
    try {
      const res = await getAllSpecialist(axiosAuth, { organizationId });
                          ...
                          <FormControl>
                            <Select
                              onValueChange={(value) => {
                                ...
                                const findOrganizationObj = organizations.find(
                                  (el) => el.name === value
                                );
                                fetchAllSpecialist(
                                  +(findOrganizationObj as any)?.id
                                );
                              }}
                      ...
                      render={({ field, fieldState }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Select
                              disabled={
                                form.getValues().organizationName ? false : true
                              }
